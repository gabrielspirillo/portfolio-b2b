...
const translations: Record<Language, Translations> = {
  es: {
    ...
    serv_1_detail: "Arquitectura e ingeniería de software Front-end y Back-end. Construyo ecosistemas web desde cero, escalables, optimizados para SEO y con las métricas de rendimiento más exigentes del sector empresarial.",
    
    serv_2_title: "Desarrollo Móvil",
    serv_2_desc: "Híbrido y Nativo para iOS / Android.",
    serv_2_detail: "Creación de aplicaciones utilizando React Native, Swift y Kotlin. Enfocadas en fluidez nativa, manejo de estados complejos y consumo eficiente de recursos del dispositivo.",
  ...
  en: {
    ...
    serv_1_detail: "Front-end and Back-end architecture. I build scalable web ecosystems from scratch, highly SEO optimized, pushing the most demanding performance metrics in the corporate sector.",
    
    serv_2_title: "Mobile Native / Hybrid",
    serv_2_desc: "iOS & Android (Swift, Kotlin, React Native).",
    serv_2_detail: "Application development focused on native fluidity, complex state management, and highly efficient device hardware consumption.",
